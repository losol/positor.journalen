...
?>
<div class="meta py-3 font-weight-300">
<?php // Show author_alias if assigned
if (get_post_meta(get_the_ID(), 'author_alias', true) != "") :
    echo '<span class="sr-only">Skribent </span><i class="material-icons align-middle">person</i>&nbsp;' . get_post_meta(get_the_ID(), 'author_alias', true); 
...
if (get_post_meta(get_the_ID(), 'photographer_alias', true) != "") :
    echo '&nbsp;<span class="sr-only">Fotograf </span><i class="material-icons align-middle">photo_camera</i>&nbsp;' . get_post_meta(get_the_ID(), 'photographer_alias', true); 
endif;
?>
<?php // Show published date
    echo '&nbsp;<i class="material-icons align-middle">date_range</i>&nbsp;Publisert ' . get_the_date('j.n.Y');
